...
--------------------------------------------------
 Author      : Azhar Baloch
 GitHub      : https://github.com/azharbaloch172
 YouTube   : AR Tricks
 Telegram  : https://t.me/artricks
--------------------------------------------------
"""
def tik():
	titik = ['.   ','..  ','... ']
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: azhar_baloch
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://t.me/azharbaloch172')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mloveBADSHA\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mloveBADSHA\033[1;95m•◈•══════••◈•"
		try:
	...
	print('           \033[1;91mbaloch start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mlundBADSHA\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By azharbalochhacker--•◈•---»" #Dev:AZHAR
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 lundBADSHA.py)↩\033[1;97m....'
